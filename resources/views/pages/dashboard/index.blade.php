          ...
          <div class="card-body">
            ...
            <div class="avatar-group">
              <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" title="Billy Hopkins"
                ...
                <img src="{{ asset('app-assets/images/portrait/small/avatar-s-9.jpg') }}" alt="Avatar" width="33"
                  height="33" />
              </div>
              <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" title="Amy Carson"
                class="avatar pull-up">
                <img src="{{ asset('app-assets/images/portrait/small/avatar-s-6.jpg') }}" alt="Avatar" width="33"
                  height="33" />
              </div>
              <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" title="Brandon Miles"
                class="avatar pull-up">
                <img src="{{ asset('app-assets/images/portrait/small/avatar-s-8.jpg') }}" alt="Avatar" width="33"
                  height="33" />
              </div>
              <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" title="Daisy Weber"
                class="avatar pull-up">
                <img src="{{ asset('app-assets/images/portrait/small/avatar-s-20.jpg') }}" alt="Avatar" width="33"
                  height="33" />
              </div>
        ...
        <div class="card card-browser-states">
          ...
          <div class="card-body">
            <div class="browser-states">
              <div class="d-flex">
                <img src="{{ asset('app-assets/images/icons/google-chrome.png') }}" class="rounded me-1" height="30"
                  alt="Google Chrome" />
            ...
            <div class="browser-states">
              <div class="d-flex">
                <img src="{{ asset('app-assets/images/icons/mozila-firefox.png') }}" class="rounded me-1" height="30"
                  alt="Mozila Firefox" />
            ...
            <div class="browser-states">
              <div class="d-flex">
                <img src="{{ asset('app-assets/images/icons/apple-safari.png') }}" class="rounded me-1" height="30"
                  alt="Apple Safari" />
            ...
            <div class="browser-states">
              <div class="d-flex">
                <img src="{{ asset('app-assets/images/icons/internet-explorer.png') }}" class="rounded me-1" height="30"
            ...
            <div class="browser-states">
              <div class="d-flex">
                <img src="{{ asset('app-assets/images/icons/opera.png') }}" class="rounded me-1" height="30"
                  alt="Opera Mini" />
