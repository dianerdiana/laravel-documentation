        ...
        <div class="card-body">
          ...
          <form class="auth-login-form mt-2" action="index.html" method="POST">
            <div class="mb-1">
              ...
              <input id="login-email" type="text" class="form-control" name="login-email" placeholder="john@example.com"
            ...
            <div class="mb-1">
              ...
              <div class="input-group input-group-merge form-password-toggle">
                <input id="login-password" type="password" class="form-control form-control-merge" name="login-password"
